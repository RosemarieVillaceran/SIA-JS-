...
//Address
let addressInput = document.getElementById("address-name-input");
let addressError = document.getElementById("address-name-error");
let emptyaddressError = document.getElementById("empty-address-name");
